defmodule HorseraceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HorseraceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HorseraceWeb.Gettext, "errors", msg, opts)
    end
  end
